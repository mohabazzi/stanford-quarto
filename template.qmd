...
title-block-banner-color: "#820000"
subtitle: "Subtitle"
...
```{r}
iuri <- knitr::image_uri(f = "_extensions/stanford-quarto/img/logo.png")
...
p <- 
  ...
  labs(
    x = "Iris species dataset", y="Sepal Width",
    title = "Seminal ggplot2 boxplot chart example",
